  ...
  return (
    <div style={{backgroundImage: `url(${bag2})`, backgroundSize:'cover'}} className='items-center justify-center flex flex-col py-20 bg-[#72e485]'>
        ...
        <div>
            ...
            <h1 className='text-center text-3xl md:text-4xl font-bold leading-[60px]'>Get TSF Bank App on Google<br /> Play or App Store</h1>

            <p className='font-medium italic text-center py-10'>Build your financial literacy within a transparent community.<br /> Follow other investors, share insights with people.</p>
